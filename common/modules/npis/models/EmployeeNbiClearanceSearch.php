...
use Yii;
/**
 * EmployeeNbiClearanceSearch represents the model behind the search form of `common\modules\npis\models\EmployeeNbiClearance`.
 */
class EmployeeNbiClearanceSearch extends EmployeeNbiClearance
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = EmployeeNbiClearance::find();
