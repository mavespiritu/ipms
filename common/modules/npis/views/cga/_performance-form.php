...
<div class="evidence-performance-form">

    <?php $form = ActiveForm::begin([
        'options' => ['id' => 'evidence-performance-form', 'enctype' => 'multipart/form-data', 'method' => 'post'],
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <?= AttachmentsInput::widget([
                        'id' => $idx.'-evidence-performance-attachment-select',
                        'model' => $evidenceModel,
                        'options' => [ 
                            'multiple' => true,
                        ],
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="pull-right">
                <?= Html::submitButton('Save Record', ['class' => 'btn btn-success', 'onclick' => "$('#".$idx."-evidence-performance-attachment-select').fileinput('upload');"]) ?>
            </div>
...
<?php
    $script = '
    $("#evidence-performance-form").on("beforeSubmit", function(e) {
        e.preventDefault();
        var form = $(this);
