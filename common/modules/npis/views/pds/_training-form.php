...
<div class="training-form">
    ...
    <?php $form = ActiveForm::begin([
        'options' => ['id' => 'training-form', 'enctype' => 'multipart/form-data', 'method' => 'post'],
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <?= AttachmentsInput::widget([
                        'id' => $idx.'-training-attachment-select',
                        'model' => $idModel,
                        'options' => [ 
                            'multiple' => false,
                        ],
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="pull-right">
                <?= Html::submitButton('Save Record', ['class' => 'btn btn-success', 'onclick' => "$('#".$idx."-training-attachment-select').fileinput('upload');"]) ?>
            </div>
...
<?php
    $script = '
    $("#training-form").on("beforeSubmit", function(e) {
        e.preventDefault();
        var form = $(this);
